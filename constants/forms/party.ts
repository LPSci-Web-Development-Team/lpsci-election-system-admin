...
export const PARTY_SCHOOL_YEAR_PLACEHOLDER = 'Select a school year...';

// ANCHOR School Year Tooltip
export const PARTY_SCHOOL_YEAR_TOOLTIP = 'This identifies the school year where this party belongs.';
